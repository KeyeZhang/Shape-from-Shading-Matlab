...
subtract_imarray = bsxfun(@minus, imarray, ambient_image)
subtract_imarray(subtract_imarray < 0) = 0
imarray = subtract_imarray./255

%%debugging: show a image after preprocessing
